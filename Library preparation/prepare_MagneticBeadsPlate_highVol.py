...
def run(protocol):
	...
	# =============================================================================
	# Tips & pipette
	tips = protocol.load_labware('opentrons_96_tiprack_300ul', 1, 'tips')
	...
	flash(f"### Prepare a skirted Falcon50 with {required_beads_vol} ul of magnetic beads and place it in position A1 of the F50 tube adapter")
